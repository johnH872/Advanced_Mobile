...
part of 'media_api_serivices.dart';
...
class _MediaApiService implements MediaApiService {
  _MediaApiService(
    this._dio, {
    this.baseUrl,
  }) {
    baseUrl ??= 'http://10.0.2.2:5000/api/MediaManagement/';
  }
