                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text('24 Junary 2024',style: TextStyle(
                              color: Colors.black,
                              fontSize: 20,
                              fontWeight: FontWeight.bold 
                            ),),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('08:00 AM',style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.bold
                  ),),
                  OutlinedButton(
                    onPressed: () { }, 
                    child: const Text('Done at 07:58', style: TextStyle(fontSize: 12), )
                  )
                ],
              ),
            ),
          ...
          Expanded(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  const Text('Clock out',style: TextStyle(
                    fontSize: 14,              
                  ),),
                  const SizedBox(
                    height: 5,
                  ),
                  const Text('05:00 PM',style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.bold
                  ),),
                  ButtonTheme(
                    ...
                    child: FilledButton(
                      onPressed: () { }, 
                      child: const Text('Not yet', style: TextStyle(fontSize: 12))
                    )
                  ),
                ],
              ),
    ...
    return Column(
      ...
      children: [
        Wrap(
          ...
          children: [
            _builderButtonFab("Time off", const Icon(Icons.next_week, color: Color(0xff389151),)),
            _builderButtonFab("Apply leave", const Icon(Icons.flight_takeoff, color: Color(0xff1A3BE7),)),
            _builderButtonFab("News", const Icon(Icons.document_scanner, color: Color(0xffC47D29),)),
            _builderButtonFab("Timesheet", const Icon(Icons.calendar_month, color: Color(0xffCA5858),)),
            _builderButtonFab("Employee", const Icon(Icons.group, color: Color(0xff6EA1EC),)),
            _builderButtonFab("Assign leave", const Icon(Icons.assignment_ind, color: Color(0xff5457A7),)),
            _builderButtonFab("Recruitment", const Icon(Icons.person_add, color: Color(0xffAB933F),)),
            _builderButtonFab("Others", const Icon(Icons.more_horiz, color: Color(0xff389151),)),
        ],)
      ],
    );
  }
